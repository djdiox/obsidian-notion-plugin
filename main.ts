	...
	async onload() {
		...
		const ribbonIconEl = this.addRibbonIcon(
			...
			async (evt: MouseEvent) => {
				...
				const db = new NotionDatabases(self.app, self.client, this.settings)
				new Notice('Loading Database via: ' + this.settings.database.link)
		...
		statusBarItemEl.setText(
			'Loading Databases ID: ' + this.settings.database.id,
		)
